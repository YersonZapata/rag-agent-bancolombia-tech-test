...
def get_article_by_url(
    ...
    ÚSALA SOLO cuando el usuario te pida más detalles sobre un producto específico cuya URL ya conoces (por ejemplo, tras usar search_knowledge_base) y necesites leer todo su contenido.
    """
